...
export const BOTTOM_STRIP_HEADING = "Repeat buys worth auditing";
export const BOTTOM_STRIP_SUBHEAD = "Household staples we track on SubAudit — partner links, no extra cost to you.";
